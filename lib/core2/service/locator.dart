...
//=====================================================================
  locator.registerLazySingleton<CartRepositoryImpl>(
      () => CartRepositoryImpl(locator<ApiService>()));
  locator.registerLazySingleton(
      () => AddToCartUseCase(locator<CartRepositoryImpl>()));
  locator.registerLazySingleton(
      () => RemoveFromCartUseCase(locator<CartRepositoryImpl>()));
  locator.registerLazySingleton(
      () => UpdateQuantityUseCase(locator<CartRepositoryImpl>()));
  locator.registerLazySingleton(
      () => GetCartItemsUseCase(locator<CartRepositoryImpl>()));
  locator.registerLazySingleton(
      () => GetTotalPriceUseCase(locator<CartRepositoryImpl>()));
//=============================================================
  locator.registerLazySingleton<FavoriteRepository>(
      () => FavoriteRepositoryImpl());
  locator.registerLazySingleton(
      () => ManageFavoritesUseCase(locator<FavoriteRepository>()));
}
